...
public class ApiClient {
    ...
    private String basePath = "https://api.ingrammicro.com:443/sandbox";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/6.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.ingrammicro.com:443/sandbox
