...
public class AsyncOrderCreateDTOAdditionalAttributesInner {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<AsyncOrderCreateDTOAdditionalAttributesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AsyncOrderCreateDTOAdditionalAttributesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AsyncOrderCreateDTOAdditionalAttributesInner>() {
           @Override
