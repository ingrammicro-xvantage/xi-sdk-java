  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<QuoteToOrderDetailsDTOAdditionalAttributesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QuoteToOrderDetailsDTOAdditionalAttributesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<QuoteToOrderDetailsDTOAdditionalAttributesInner>() {
           @Override
